...
function ubermenu_register_skins_pro(){
	...
	ubermenu_register_skin( 'charcoal' , 'Charcoal' , $main.'charcoal.css' );
	...
	<div class="ubermenu-welcome <?php if( !$show_welcome ) echo 'ubermenu-welcome-hide'; ?>">
		<div class="ubermenu-welcome-inner">
			...
			<div class="ubermenu-welcome-buttons">
				...
				<a target="_blank" class="button button-secondary button-new-license" href="http://wpmegamenu.com"><i class="fa fa-shopping-cart"></i> Get another license</a>
			</div>
